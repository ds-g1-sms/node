...
This document defines key terms and concepts used throughout the distributed chat system.
...
A distributed transaction protocol ensuring all nodes agree on an operation. In this system:
